...
public class EmailUtils {
	...
	public static void sendReport(String reportPath) {
		...
		final String senderEmail="kratiautomation02@gmail.com";
		final String appPassword="mtwavduzskyoohhj";
		final String recipientEmail="kratiautomation02@gmail.com";
		...
		try {
			...
			System.out.println("Attachement filepath="+ reportPath);
